#!/bin/sh
aws s3 cp ./calculator.html s3://75mm.studio --acl public-read --profile 75mm.studio
aws s3 cp ./js/calculator.js s3://75mm.studio/js/ --acl public-read --profile 75mm.studio
